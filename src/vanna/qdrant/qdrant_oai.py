...
class Qdrant_VectorStore(VannaBase):
    ...
    def __init__(
        ...
        self.embedder_client = config.get("embedder_client", "text-embedding-ada-002")
        self.embedder_model = config.get("embedder_model", "text-embedding-ada-002")
    ...
    def generate_embedding(self, data: str, **kwargs) -> list[float]:
        embedding = self.embedder_client.embeddings.create(model=self.embedder_model, input=data).data[0].embedding
        return embedding
